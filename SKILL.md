...
| 合盘、关系比较 | `reference/module_4_heban.md`、`reference/response_boundary.md`、`reference/interpretation_protocol.md`、`reference/answer_style.md` | 详细文案读 `prompts/heban.md` |
