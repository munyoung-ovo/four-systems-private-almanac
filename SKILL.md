...
8. 默认给短而完整的结果；用户明确要求详细版、报告或文件时再展开。长文写入 `outputs/`，聊天只给摘要和路径。
...
| 今日、某日、具体事项择日 | `reference/module_1_today.md` | `prompts/daily_tongshu.md` 或 `prompts/electional.md` |
| 命盘、事业、感情、财运、贵人、健康 | `reference/module_3_chart.md`、`reference/response_boundary.md`、`reference/interpretation_protocol.md` | 短答读 `prompts/deep_chart_brief.md`；详细版读 `prompts/deep_chart_long.md` |
| 合盘、关系比较 | `reference/module_4_heban.md`、`reference/response_boundary.md`、`reference/interpretation_protocol.md` | 详细文案读 `prompts/heban.md` |
...
- 下一步入口只保留当前最相关的 2-4 个；用户要求返回菜单时再显示完整菜单。
